												...
												<div class="tile">
																...
																<div class="tile-body">
																				<div class="tile ">
                                                                                    <div class="row">
                                                                                        <h4>Categories</h4>
                                                                                        <h5 class="display-5  mt-1 ml-2 text-info">{{ count($categorydata['categories']) }} Categories</h5>
                                                                                    </div>
                                                                                    <hr>
																								<a href="/admin/articles/category/create" class="btn btn-primary">Create Category</a>
																				</div>
																</div>
								...
								<div class="col-lg-8 col-xl-8">
												@foreach ($categorydata['categories'] as $category)
																...
																<div class="tile post-div mt-2">
                                                                    <a href="/post/show/{{$category->id}}" class="btn btn-secondary">Edit</a>
