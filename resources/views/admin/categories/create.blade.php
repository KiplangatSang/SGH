        ...
        <form method="POST" action="/admin/articles/category/store" enctype="multipart/form-data" id="articleForm">
            ...
            <div class="form-group ">
                ...
                <select class="form-control  @error('category_class') is-invalid @enderror" name="category_class">
                    <optgroup label="Choose a class">
                        @foreach ($categorydata['category'] as $key => $category)
            ...
            <div class="form-group">
                ...
                <input type="heading" name="category" class="form-control @error('category') is-invalid @enderror" id="category" placeholder="Enter the category eg Poems" value="{{ old('category') }}">
                @error('category')
                <span class="invalid-feedback  p-1" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <textarea name="category_description" placeholder="Give a short description about the category" class="textarea form-control @error('category_description') is-invalid @enderror " rows="10">{{ old('category_description') }}</textarea>
