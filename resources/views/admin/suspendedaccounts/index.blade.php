																																...
																																@foreach ($accountsdata['accounts'] as $account)
																																				<tr>
																																								...
																																								@if ($account->isSuspended)
                                                                                                                                                                                ...
                                                                                                                                                                                <td><a class="btn btn-primary" href="/admin/account/users/update/{{ $account->id }}">Activate</a></td>
																																								</a>
																																								@else
																																												<td>
																																																Active
																																												</td>
                                                                                                                                                                                <td><a class="btn btn-primary" href="/admin/account/users/update/{{ $account->id }}">Suspend</a></td>
																																								</a>
																																								@endif
