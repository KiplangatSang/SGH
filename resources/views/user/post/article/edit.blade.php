...
@section('content')
				<div class="row m-1">
																																...
																																@foreach ($postdata['top_images'] as $image)
																																				<div class="row m-1">
																																								<div class="col-md-2 icon m-1">
																																												<img src="{{ $image->post_top_image }}" alt="{{ $image->post_top_image }}"
																																																width="35" height="35">
																																								</div>
																																								<input type="text" value="{{ $image->post_top_image }} "
								...
								<div class=" col-md-8 col-xl-8">
                                    {{-- <form action="/post/image/firebase" method="POST" enctype="multipart/form-data">
                                        @csrf
