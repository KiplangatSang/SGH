...
<div class="row m-1">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row m-1">
                                <div class="col-md-2 icon m-1">
                                    <img src="{{ $image->image }}" alt="{{ $image->image }}" width="35" height="35">
                                </div>
                                <input type="text" value="{{ $image->image }} " id="imageUrlInput{{ $image->id }}" class="disabled">
    ...
    <div class=" col-md-8 col-xl-8">
        ...
        <div class="row m-1">
            <div class="col-md-2 icon m-1">
                <img src="{{ $image->post_top_image }}" alt="{{ $image->post_top_image }}" width="35" height="35">
            </div>
            <input type="text" value="{{ $image->post_top_image }} " id="imageUrlInput{{ $image->id }}" class="disabled">
        ...
        <div class="form-group bg-white">
            ...
            <div class="tile-body p-3">
                <p>Drag and drop here.</p>
                <form class="dropzone ce" method="POST" enctype="multipart/form-data" action="/post/image/title/store/1" id="title_image-upload">
                    @csrf
