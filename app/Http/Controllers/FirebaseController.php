...
class FirebaseController extends Controller
{
    ...
    public function create()
    {
        ...
        $factory = (new Factory)
        ->withServiceAccount(base_path(env('FIREBASE_CREDENTIALS')))
        ->withDatabaseUri('gs://storm3blog.appspot.com');

        $storage =  $factory
    ->withDefaultStorageBucket('gs://storm3blog.appspot.com')
    ->createStorage();

    $bucketName = "blog";
    $objectName = 'image_test';
   // 'Photos/test.jpeg';

  $bucket = $storage->getBucket($bucketName);


$object = $bucket->upload(fopen( public_path('/articleImages/62515878a0965_Profile.png'), 'r'), [
   'name' => $objectName,
